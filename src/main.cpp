...
bool init()
{
    ...
    if( SDL_Init( SDL_INIT_VIDEO ) < 0 )
    {
        ...
        if( gWindow == NULL )
        {
            ...
            // Created vsynced renderer for window
            gRenderer = SDL_CreatedRenderer( gWindow, -1, SDL_RENDERER_ACCELERATED | SDL_RENDERER_PRESENTVSYNC );
            if ( gRenderer == NULL )
            {
...
bool loadMedia()
{
    ...
    {
        printf( "Failed to load arror texture!\n" );
        success = false;
    }
